...
<head>
    ...
    .auth-right .right-bg { height: calc(100vh - 24px); margin:12px; border-radius:12px; background-image:url('<?=$dirAsset?>/images/fkp_students.jpg'); background-size:cover; background-position:center center; }
  ...
  <div class="auth-left">
    <div class="login-card">
       <div class="login-logo" style="font-family:verdana">
        <?= Html::img(Yii::$app->params['backendUrl'] . '/images/logo-fkp-portal.png', ['alt' => 'FKP Portal', 'style' => 'max-width:160px;height:auto;margin-bottom:6px;']) ?><br />
        <span style="font-size:22px"><b>STUDENT LOGIN</b></span>
      </div>
      <?= Alert::widget() ?>
      <?= $content ?>
    </div>
