<?php
namespace frontend\modules\conference\models;
...
class UploadFile
{
	...
	public static function fileInput($model, $attr, $image = false, $multiple = false, $redirect = false){
		...
		if($multiple){
			...
			$view = '@frontend/modules/conference/views/upload/main-file';
		}
        ...
        'url' => [$model->file_controller . '/upload-file', 'confurl'=> $model->conference->conf_url, 'attr'=> $attr, 'id' => $model->id],
