...
<div class="item-blog-txt">
	...
	<br />
		<p>*If you have registered with FKP PORTAL, you can proceed to <?=Html::a('login page', ['/conference/site/login', 'confurl' => $model->conf_url])?> or you can register by filling in your email below and click next.</p>
