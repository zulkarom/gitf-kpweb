...
class DocumentSearch extends Document
{
    ...
    {
        return [
            [['id', 'participant_id', 'downloaded'], 'integer'],
            [['participant_name', 'field1', 'field2', 'field3', 'field4', 'field5'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'participant_name', $this->participant_name])
