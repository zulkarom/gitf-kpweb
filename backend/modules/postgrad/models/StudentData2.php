...
/**
 * This is the model class for table "pg_student_data2".
 *
 * @property int $id
 ...
 */
class StudentData2 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['NO_IC'], 'string', 'max' => 14],
            [['TARIKH_LAHIR', 'KEWARGANEGARAAN', 'TARAF_PENGAJIAN'], 'string', 'max' => 12],
            [['NEGARA_ASAL'], 'string', 'max' => 8],
            [['KOD_PROGRAM'], 'string', 'max' => 3],
            [['ALAMAT'], 'string', 'max' => 89],
            [['DAERAH', 'TARIKH_KEMASUKAN'], 'string', 'max' => 100],
            ...
            [['CGPA_SARJANA_MUDA', 'TAHUN_SARJANA_MUDA'], 'string', 'max' => 4],
            [['SESI_MASUK'], 'string', 'max' => 42],
            [['PEMBIAYAAN'], 'string', 'max' => 200],
            [['KAMPUS'], 'string', 'max' => 11],
            [['TAHUN_KEMASUKAN', 'SEMESTER', 'NO_TELEFON'], 'safe'],
