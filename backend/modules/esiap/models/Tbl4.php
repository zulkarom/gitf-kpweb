...
<td width="'.$col_sem_bal.'" colspan="7" '.$style_shade.'></td>
</tr>
...
$html .= '<tr>
<td width="'.$colnum.'" '.$style_shade.' align="center" rowspan="3">9. </td>

<td width="'.$col_trans_label.'" colspan="6" '.$style_shade.' rowspan="3">
...
<td width="'.$col_trans_number.'" '.$style_shade.' align="center">1</td>
<td colspan="8" width="'.$col_trans_bal.'" '.$border.'></td>

</tr>

<tr>

<td width="'.$col_trans_number.'" '.$style_shade.' align="center">2</td>
<td colspan="8" width="'.$col_trans_bal.'" '.$border.'></td>
...
<td width="'.$col_trans_number.'" '.$style_shade.' align="center">3</td>
<td colspan="8" width="'.$col_trans_bal.'" '.$border.'></td>
