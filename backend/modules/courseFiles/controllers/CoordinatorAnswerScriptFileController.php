 ...
 */
class CoordinatorAnswerScriptFileController extends Controller
{
    /**
    ...
    public function actionPage($id)
    {
        ...
        return $this->render('/coordinator-test/class-answer-script-upload', [
            'model' => $model,
        ]);
    }
    ...
    public function actionUploadFile($attr, $id){
        ...
        $model = $this->findCoordinatorAnswerScript($id);
        $model->file_controller = 'coordinator-answer-script-file';
        $path = 'course-files/'.$model->offered->semester_id.'/'.$model->offered->course->course_code.'/'.$model->offered->id.'/15-class-student-final-exam-answer-script';
