 ...
 */
class CoordinatorSummativeAssessmentFile extends \yii\db\ActiveRecord
{
    ...
    {
        return 'cf_coor_sum_assess_class';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['offered_id', 'updated_at'], 'required', 'on' => 'add_summative_assessment'],
