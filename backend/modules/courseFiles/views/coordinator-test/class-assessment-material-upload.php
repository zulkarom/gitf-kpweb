...
<div style="margin-bottom:10px;font-size:14px">Copies of Continous Assessment Materials</div>
...
<tbody>
	<?php 
	if($model->coordinatorAssessmentMaterialFiles){
		foreach($model->coordinatorAssessmentMaterialFiles as $file){
...
<br />
<a href="<?=Url::to(['coordinator-assessment-material-file/add', 'id' => $model->id])?>" class="btn btn-default" ><span class="glyphicon glyphicon-plus"></span> Add Assessment Material Document</a>
</div></div>
