...
<?php /* <div class="form-group"><?= Html::a('Manage Class Date', ['/course-files/default/lecture-student-attendance-date', 'id' => $tutorial->id], ['class' => 'btn btn-success']) ?></div> */?>
<div class="row">
  <div class="col-md-6">
  ...
  <br />
   ...
   <div class="form-group" align="right">
	...
	if($attendance){
		...
		<div class="form-group"><a href="'.Url::to(['tutorial-attendance-sync', 'id' => $tutorial->id]).'" class="btn btn-success">Load Attendance Data</a></div>
		';
	}
                  ...
                  ?>
					...
					$input_html = '';
                      foreach ($tutorial->students as $student) {
                        if($student->tutorial_id == $tutorial->id){
							$comma = $x == 1 ? '': ',';
                          ...
                          <td>'.$student->student->st_name.'</td>';
                            ...
                            {
                                $column = json_decode($tutorial->attendance_header);
								$str = '[';
                                if($column){
									$iv = 1;
...
<?php 
$check = $tutorial->prg_attend_complete == 1 ? 'checked' : ''; ?>
<label>
