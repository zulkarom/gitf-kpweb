            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons'=>[
                    'update' => function ($url, $model) {
                        return Html::a('<span class="fa fa-edit"></span>',['update', 'id' => $model->id, 'proc' => $model -> chap_id],['class'=>'btn btn-warning btn-sm']);
                    },
                    'view' => function ($url, $model) {
                        return Html::a('<span class="fa fa-eye"></span>',['view', 'id' => $model->id, 'proc' => $model -> chap_id],['class'=>'btn btn-success btn-sm']);
                    },
