...
<a href="#" id="remove_<?=$unique?>" class="btn btn-danger" data-type="POST" data-url="<?=Url::to([$model->file_controller . '/delete-row', 'attr' => $attr_name, 'id' => $model->id])?>" title="Delete"><span class="fa fa-remove"></span></a>
